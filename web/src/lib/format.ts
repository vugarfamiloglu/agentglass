...
/**
 * Model label for a table cell, e.g. "claude-opus-4-8-20260101" → "claude-opus-4-8".
 * The vendor prefix stays: with ten providers in play it says which one this is,
 * and dropping it leaves ids like "gpt-5" as a bare "5".
 */
